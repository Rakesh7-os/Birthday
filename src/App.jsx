      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Dayyam</span> 🎂
              </>
            ) : (
              <>
          ...
          <p> Big birthday wishes to the most beautiful girl I know!  I hope that your day is as fabulous as you are!☺️✨💗</p>
        </section>
